...
(function() {
	...
	getTranslateX: function () {		
	    ...
	    */
	    var dx = this._touches[1] - this._touches[0];
            ...
            console.log('this._touches[1]: ' + this._touches[1]);
    ...
    */
    ...
    function handleStart (evt) {
        evt.preventDefault();
        var tch = evt.changedTouches;
            toggleTracker.addMovement(tch[0].screenX);
            console.log('touchstart ' + tch[0].screenX);
            sliding = true;
    }
    ...
    function handleMove (evt) {
        var tch = evt.changedTouches;
            evt.preventDefault();
            toggleTracker.addMovement(tch[0].screenX);
            console.log('touchmove: ' + tch[0].screenX);
	...
	*/
        ...
        toggle.addEventListener('touchstart', handleStart, false);
        toggle.addEventListener('touchmove', handleMove, false);
        toggle.addEventListener('touchend', handleEnd, false);
        toggle.addEventListener('touchcancel', handleCancel, false);
    }
